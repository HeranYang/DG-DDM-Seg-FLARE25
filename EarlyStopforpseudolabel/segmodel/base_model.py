...
class BaseModel(object):
    ...
    def initialize(self, opt):
        ...
        self.snapshot_dir = opt['checkpoint']
        self.pred_dir = opt['results']
    ...
    def save_network(self, network, network_label, epoch_label, gpu_ids, rootpath):
        save_filename = '%s_net_%s.pth' % (epoch_label, network_label)
        save_path = os.path.join(rootpath, save_filename)
        print(save_path)
