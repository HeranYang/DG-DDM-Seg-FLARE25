...
def parse(args):
    ...
    experiments_root = os.path.join(
        'experiments', '{}_{}_{}_{}'.format(opt['name'], get_timestamp(),
                                            opt['datasets']['train']['cond_image_sequence'],
                                            opt['datasets']['train']['output_label_sequence'])) # opt['datasets']['train']['cond_pesudolabel_sequence']))
