...
class WandbLogger:
    ...
    def log_checkpoint(self, current_epoch, current_step):
        ...
        gen_path = os.path.join(
            self.config.result_path['checkpoint'], 'I{}_E{}_gen.pth'.format(current_step, current_epoch))
        opt_path = os.path.join(
            self.config.result_path['checkpoint'], 'I{}_E{}_opt.pth'.format(current_step, current_epoch))
